...
| 8 | **Claude-only this week**; cross-harness + unit-loop deferred | Don't boil the ocean; Sprint 1 is a single-harness skeleton | Completion over scope — _superseded 2026-07-22: cross-harness proven early (#22), now the deliberate Sprint-2 demo push (see `docs/plans/2026-07-22-001-cross-harness-wow-plan.md`)_ |
